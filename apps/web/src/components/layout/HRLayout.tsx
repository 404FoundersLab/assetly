      ...
      <Box
        ...
        sx={{
          ...
          backgroundImage: isDark
            ? 'radial-gradient(ellipse 90% 50% at 50% -10%, rgba(16, 185, 129, 0.06), transparent)'
            : 'radial-gradient(ellipse 90% 50% at 50% -10%, rgba(16, 185, 129, 0.02), transparent)',
          minHeight: '100vh',
          overflowX: 'hidden',
        }}
      >
